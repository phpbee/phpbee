...
$local_config_filename=__DIR__.DIRECTORY_SEPARATOR.'config.local.php';
if (file_exists($local_config_filename)) include_once($local_config_filename);
...
if (!defined('UDP_DEBUG')) DEFINE ('UDP_DEBUG',0);
if (!defined('LOG_CONSOLE')) DEFINE ('LOG_CONSOLE',0);
if (!defined('DEBUG_LEVEL')) DEFINE ('DEBUG_LEVEL',255);
