...
class gs_widget_ImageImportSocial extends gs_widget_MultiPowUpload {
	function html() {
        ...
        return $tpl->fetch('widget_ImageImportSocial.html');
...
class gs_widget_ImageImportSocial_module extends gs_base_module implements gs_module {
    ...
    static function get_handlers() {
        $data=array(
                  'handler'=>array(
                      '/widgets/ImageImportSocial/action'=>array(
                          'gs_widget_ImageImportSocial_handler.action',
                          'gs_base_handler.redirect',
                      ),
                  ),
                  'get'=>array(
                      '/widgets/ImageImportSocial/upload'=>array(
                          'gs_widget_ImageImportSocial_handler.upload',
                      ),
                      '/widgets/ImageImportSocial/search'=>array(
                          'gs_widget_ImageImportSocial_handler.search',
                      ),
                    '/libs/widgets/ImageImportSocial/'=>'gs_widget_ImageImportSocial_handler.public_html',
                  ),
              );
        return self::add_subdir($data,dirname(__file__));
    }
}
class gs_widget_ImageImportSocial_handler extends gs_widget_MultiPowUpload_handler {
	...
	function upload() {
		...
		$file->fill_values($img->File->fetch_image(urldecode($this->data['src'])));
	...
	function li($f) {
		...
		$tpl->template_dir=cfg('lib_dir').DIRECTORY_SEPARATOR.'widgets'.DIRECTORY_SEPARATOR.'ImageImportSocial'.DIRECTORY_SEPARATOR.'templates';
		$tpl->assign('i',$f);
		echo $tpl->fetch('li_image_ImageImportSocial.html');
	}
