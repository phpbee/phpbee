...
class gs_widget_damnUploader_module extends gs_base_module implements gs_module {
	...
	static function get_handlers() {
		$data=array(
		'handler'=>array(
			'/widgets/damnUploader/action'=>array(
				'gs_widget_damnUploader_handler.action',
				'gs_base_handler.redirect',
			),
		),
		'post'=>array(	
			'/widgets/damnUploader/upload'=>array(
				'gs_widget_damnUploader_handler.upload',
			),
		),
		'get'=>array(
			/*
			'/libs/widgets/damnUploader/widget.css'=>'gs_widget_damnUploader_handler.public_html:content-type:text/css',
			'/libs/widgets/damnUploader/widget.js'=>'gs_widget_damnUploader_handler.public_html:content-type:application/javascript',
			'/libs/widgets/damnUploader/Extra/swfobject.js'=>'gs_widget_damnUploader_handler.public_html:content-type:application/javascript',
			*/
			'/libs/widgets/damnUploader/'=>'gs_widget_damnUploader_handler.public_html',
			'/widgets/damnUploader/'=>'gs_widget_damnUploader_handler.public_html',
		),
		);
...
class gs_widget_damnUploader_handler extends gs_handler {
	...
	function li($f) {
		...
		$tpl->template_dir=cfg('lib_dir').DIRECTORY_SEPARATOR.'widgets'.DIRECTORY_SEPARATOR.'damnUploader'.DIRECTORY_SEPARATOR.'templates';
        */
        $tpl=new gs_tpl();
		$tpl=$tpl->init();
        $tpl->addTemplateDir(dirname(__FILE__).DIRECTORY_SEPARATOR.'templates');
		$tpl->assign('i',$f);
		echo $tpl->fetch('li_damnUploader.html');
	}
}

class gs_widget_damnUploader extends gs_widget{
	function html() {
		...
		return $tpl->fetch('widget_damnUploader.html');
