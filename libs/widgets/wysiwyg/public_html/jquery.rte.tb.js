...
function lwrte_image() {
	...
	<ul class="rte_img_align">\
	<li><a href="#" onclick="$(\'.rte-panel #url_align\').get(0).value=this.className; $(\'.rte_img_align li\').removeClass(\'current\'); this.parentNode.className=\'current\'; return false;" class="left"></a></li>\
	<li><a href="#" onclick="$(\'.rte-panel #url_align\').get(0).value=this.className; $(\'.rte_img_align li\').removeClass(\'current\'); this.parentNode.className=\'current\'; return false;" class="right"></a></li>\
	<li><a href="#" onclick="$(\'.rte-panel #url_align\').get(0).value=this.className; $(\'.rte_img_align li\').removeClass(\'current\'); this.parentNode.className=\'current\'; return false;" class="no"></a></li>\
	</ul>\
	</td><td><iframe src="'+self.images_link+'" frameborder="0" width="100%" height="200"></iframe></td></tr></table>\
	</p>\
	<div class="clear"></div>\
	<p class="submit"><button id="ok">Ok</button><button id="cancel">Cancel</button></p>'
).show();
	...
	$('#ok', panel).click( 
		function() {
			...
			if (file) {
				str=(align!='no') ? 'align="'+align+'"' : '';
				self.selection_insert('<img src="'+file+'" '+str+'>');
				panel.remove(); 
			}
			return false;
		}
